...
WebUI.sendKeys(findTestObject('Register/input_Email'), GlobalVariable.valid_email)

WebUI.setText(findTestObject('Register/input__Password'), GlobalVariable.password)

WebUI.setText(findTestObject('Register/input__Konfirmasi Password'), 'Password')

WebUI.verifyElementText(findTestObject('Register/p_Konfirmasi kata sandi tidak cocok'), 'Konfirmasi kata sandi tidak cocok.')
