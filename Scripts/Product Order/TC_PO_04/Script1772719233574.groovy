...
WebUI.setText(findTestObject('Product Order/input__User ID'), '222222')

WebUI.setText(findTestObject('Product Order/input__Zone ID'), '11111')
...
WebUI.verifyTextPresent('Akun yang anda masukkan tidak terdaftar', false)
