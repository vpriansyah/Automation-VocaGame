...
WebUI.sendKeys(findTestObject('Forgot Password/input__Nomor whatsapp atau Email'), 'hyduziqo@fxzig.com')
...
WebUI.verifyTextPresent('OTP salah. Silakan cek dan masukkan kembali.', false)
